...
var start_button = document.querySelector("[data-start='']");
start_button.disabled = true;
var timerId = null;
var countdown;
var refs = [document.querySelector("[data-days='']").textContent, document.querySelector("[data-hours='']").textContent, document.querySelector("[data-minutes='']").textContent, document.querySelector("[data-seconds='']").textContent];
var options = {
  enableTime: true,
  time_24hr: true,
  ...
  onClose: function onClose(selectedDates) {
    if (selectedDates[0] < options.defaultDate) window.alert('Please choose a date in the future');else start_button.disabled = false;
  }
};
var fp = (0, _flatpickr.default)('input#datetime-picker', options);
